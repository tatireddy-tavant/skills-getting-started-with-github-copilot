...
activities = {
    ...
    "Basketball Club": {
        "description": "Work on drills, teamwork, and friendly basketball games",
    ...
    "Music Ensemble": {
        "description": "Practice music pieces and perform as a school ensemble",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "ryan@mergington.edu"]
    },
    "Science Bowl": {
        "description": "Compete in academic quiz challenges across science subjects",
